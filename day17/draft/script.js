  ...
  fetch("https://restcountries.com/v3.1/all")
    ...
    .then((data) => {
      ...
      const weatherPromises = countries.map((country) => {
        ...
        return fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&appid=37ba9824a231c697643e4a57ef092cf6`)
          .then((response) => response.json())
          .then((weatherData) => ({ countryData: country, weatherData }));
      });
